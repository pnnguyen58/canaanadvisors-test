...
const (
	OrderService_CreateOrder_FullMethodName = "/canaanadvisors.OrderService/CreateOrder"
)
...
func (c *orderServiceClient) CreateOrder(ctx context.Context, in *OrderCreateRequest, opts ...grpc.CallOption) (*OrderCreateResponse, error) {
...
func (UnimplementedOrderServiceServer) CreateOrder(context.Context, *OrderCreateRequest) (*OrderCreateResponse, error) {
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "canaanadvisors.OrderService",
