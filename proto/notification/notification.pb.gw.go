...
func request_NotificationService_Send_0(ctx context.Context, marshaler runtime.Marshaler, client NotificationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq NotificationSendRequest
...
func RegisterNotificationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NotificationServiceServer) error {
	...
	mux.Handle("POST", pattern_NotificationService_Send_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/canaanadvisors.NotificationService/Send", runtime.WithHTTPPathPattern("/notifications"))
		if err != nil {
...
func RegisterNotificationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NotificationServiceClient) error {
	...
	mux.Handle("POST", pattern_NotificationService_Send_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/canaanadvisors.NotificationService/Send", runtime.WithHTTPPathPattern("/notifications"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_NotificationService_Send_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"notifications"}, ""))
)
